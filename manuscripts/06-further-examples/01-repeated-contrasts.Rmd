...
`r chunk_reveal("manual-repeated-contrasts", left_assign = "detect", break_type = "rotate", title = "## 対比行列を要因に当てはめ，線形モデルを実行",  display_type = c("code", "output", "md"), md = c("仮説行列から作ったrepeated contrastsを適用", "**contr.sdif(3)**で作ったrepeated contrastsを適用", "希望するcontrastsになったか確認", "統計モデル構築", "結果表示", "より見やすく結果表示"), widths = c(3, 2, 1))`
